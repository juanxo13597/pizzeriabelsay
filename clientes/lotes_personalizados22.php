...
if ($ingrediente7!="") {
	$consulta7=mysqli_query($conexion,"SELECT * FROM $tabla32 WHERE id_pizza=$ingrediente7");
	$registro=mysqli_fetch_row($consulta7);
		 	
		$nombre_ingrediente7=$registro[1];
		$precio_ingrediente7=$registro[2];	
}
...
$pag="lotes_personalizados_2.php";
...
}elseif($ingrediente7=="0"){

	echo "Pizza", ".$nombre_ingrediente6";

}else{

	$ingredientes="Pizza ".$nombre_ingrediente7;
...
?>
<div id="personalizar">
<div id="titulo">TU LOTE 4 PERSONALIZADO</div>
<table border="0">


    <tr>

		<td><strong>Tu pizza =></strong></td>
		
		<td>
			<?php echo $nombre_ingrediente7; ?>
...
$datos="'$id_personalizada','$id_pizza','$id_cliente','$nombre','$ingredientes','1001','$precios','$preciol'";
